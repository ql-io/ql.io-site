...
describeStatement
         ::= ( 'describe' | 'desc' )  table
insertStatement
         ::= 'insert' 'into' table '(' columnsClause ')' 'values' '(' csv ')' 'with'* parts*
insertStatement
         ::= 'insert' '"' '{' jsonobj '}' '"' 'into' table
insertStatement
         ::= 'insert' 'into' table '(' columnsClause ')' 'values' '(' opaqueinput ')'
updateStatement
         ::= 'update'  table ' with ' '"' '{' jsonobj '}' '"'
deleteStatement
         ::= 'delete'  'from'  table  whereClause
If-Else
         ::= 'If' '(' mycond ')' '{' DoSomething '}' Else* '{' DoAnotherthing* '}' return* '{' Something* '}'
Try-Catch
         ::= 'try' '{' statementA 'throw'* '(' variable ')' 'catch'* '(' variable ')' statementB finally statementC '}'
