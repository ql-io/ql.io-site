...
<GMMobileNotificationConfigureReq xmlns="urn:ebay:api:PayPalAPI">
 <Request>
  ...
  {{#params}}
  <DeviceReferenceToken>{{DRT}}</DeviceReferenceToken>
  <DeviceToken type="xs:string">{{device_token}}</DeviceToken>
  <SessionToken xsi:type="ns:IVRSessionToken">{{session_token}}</SessionToken>
  {{/params}}
 </Request>
</GMMobileNotificationConfigureReq></SOAP-ENV:Body></SOAP-ENV:Envelope>